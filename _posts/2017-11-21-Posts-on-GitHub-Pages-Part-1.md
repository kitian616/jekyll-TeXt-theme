...
If you use only 1 `$`, it would be displayed inline. Note that GitHub Pages(jekyll) uses kmarkdown, and it seems that it has problem supporting inline mathematical display. 
