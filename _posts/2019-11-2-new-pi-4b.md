...
![树莓派图片视角1](./imgs/pi-1.jpg "这一面能看到新的USB-C供电和两个microHDMI")
...
​
![树莓派图片视角2](./imgs/pi-2.jpg "这一面能看见两个USB3.0接口，另外这个金属外壳能很好避免直接触碰电路板")
...
![Raspbian Buster系统下载选择界面](./imgs/raspbian.jpg)
...
![CP201x俯视图](./imgs/CP201x-1.jpg "CP201x系列")
​
![CP201x与树莓派](./imgs/CP201x-2.jpg)

插上模块之后执行指令lsusb查看USB设备。
​
![lsusb](./imgs/lsusb.png)
...
​
![python3-list_ports](./imgs/python3-list_ports.png)
...
​
![串口模块测试](./imgs/CP201x-3.jpg "短接TXD和RXD")

使用Python3交互界面进行测试。
​
![python3 serial](./imgs/python3.jpg)
...
在Python3下使用如下脚本来测试。
​
![python3 cv](./imgs/python3-cv.png)
